...
public class CourseRecyclerAdapter4 extends RecyclerView.Adapter<CourseRecyclerAdapter4.MyViewHolder>{
    ...
    public CourseRecyclerAdapter4(List<Course> recyclerViewItems, Context context) {
