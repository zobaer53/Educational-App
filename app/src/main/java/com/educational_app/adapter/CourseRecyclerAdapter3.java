...
public class CourseRecyclerAdapter3 extends RecyclerView.Adapter<CourseRecyclerAdapter3.MyViewHolder>{
    ...
    public CourseRecyclerAdapter3(List<Course> recyclerViewItems, Context context) {
