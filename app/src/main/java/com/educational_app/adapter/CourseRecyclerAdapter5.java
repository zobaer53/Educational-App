...
public class CourseRecyclerAdapter5 extends RecyclerView.Adapter<CourseRecyclerAdapter5.MyViewHolder>{
    ...
    public CourseRecyclerAdapter5(List<Course> recyclerViewItems, Context context) {
