...
import com.educational_app.activity.QuizActivity;
...
public class TestRecyclerAdapter extends RecyclerView.Adapter<TestRecyclerAdapter.MyViewHolder>{
    ...
    public TestRecyclerAdapter(List<RecyclerViewItem> recyclerViewItems, Context context, String courseID, String topicName) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements  View.OnClickListener {
        ...
        public void onClick(View v) {
           ...
           // Toast.makeText(context, "position Test " + getAdapterPosition()+" "+recyclerViewItems.get(getAdapterPosition()).getTitle(), Toast.LENGTH_SHORT).show();
